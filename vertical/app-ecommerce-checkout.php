                                            ...
                                            <?php 
                                                if(isset($_GET["id"])){
                                                    ...
                                                    while ($data = mysqli_fetch_array($query)){
                                                        $_SESSION['custid']= $data["PelangganID"];
                                                        ...
                                                        if (!empty($_SESSION['shop'])) {
                                                            ...
                                                            echo"<td>
                                                                   ".$product['jumlah']."
                                                                    ...
                                                                    $_SESSION['jumstok'] =$product['jumlah'];
                                                            echo"<td>
                                        ...
                                        <form action="app-ecommerce-invoice-proses.php" method="POST">
                                            <table class="table mb-0">
                                                <tbody>
                                                    ...
                                                    echo"<td><input  type='hidden' name='subtotal'>".$totalPrice."</td>";
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">                            
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input placeholder="Card number" class="form-control" type="tel" name="number" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">                            
                                                                        <div class="form-group">
                                                                            <label>Full Name</label>
                                                                            <input placeholder="Full name" class="form-control" type="text" name="name" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-6">                            
                                                                        <div class="form-group">
                                                                            <label>Ex. Date</label>
                                                                            <input placeholder="MM/YY" class="form-control" type="tel" name="expiry" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="container">      
                                                                        ...
                                                                        <form  method="post">                                 
                                                                            ...
                                                                            <div class="form-group col-lg-7">
                                                                                ...
                                                                                <button type="submit" class="btn btn-success " name="cashbut">Hitung kembalian</button>                                                          
                                                                            </div> 
                                                                        ...
                                                                        <form action="app-ecommerce-invoice-proses.php" method="POST">
                                                                             <button type="submit" class="btn btn-success offset-lg-10" name="invoice" >Continue</button>
                                                                        </form>
                                                                    </div>
                                                                </div>
                                                            </div>
