    ...
    <body>
        ...
        <div class="page-wrapper">
           ...
           <div class="page-content">
                        ...
                        <form action="" method="get">
                            <div class="form-group">
                                ...
                                <select name="kategori" id="kategori" class="form-control" onchange="this.form.submit()">
                                    ...
                                    <?php
                                    $query_kategori = mysqli_query($koneksi, "SELECT DISTINCT * FROM kategoriproduk");
                                    while ($isi_kategori = mysqli_fetch_assoc($query_kategori)){
                                    ?>
                                        <option value="<?php echo $isi_kategori['KategoriID']; ?>" <?php echo (isset($_GET['KategoriID']) && $_GET['KategoriID'] == $isi_kategori['KategoriID']) ? 'selected' : ''; ?>>
                                            <?php echo $isi_kategori['NamaKategori']; ?>
                                        </option>
                                    <?php }?>
                                </select>
                            </div>
            ...
            <?php
            $pilih_kategori = isset($_GET['kategori']) ? $_GET['kategori'] : '';
            $query_produk = "SELECT * FROM produk";
            if ($pilih_kategori) {
                $query_produk .= " WHERE KategoriID = '$pilih_kategori'";
            }
            $query = mysqli_query($koneksi, $query_produk);
